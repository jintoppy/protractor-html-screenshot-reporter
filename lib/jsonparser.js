...
phssr.makeHardCodedStyleTag = function(reporterOptions){
    ...
    styleTag+= "td.device-col{width:100px;}th.device-col{width: 100px;}";
...
phssr.makeHTMLPage = function(tableHtml, reporterOptions){
    ...
    staticHTMLContentprefix +=  "<th class='device-col'>Device</th>";
...
function generateHTML(data){
    ...
    str +=  '<td class="device-col">' + data.device + '</td>';
